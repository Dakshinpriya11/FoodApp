...
export default function CartItemRow({ item, onAdd, onRemove }: Props) {
  ...
  return (
    <View style={styles.card}>
      {/* Item Image */}
      <Image source={item.image || burgerImage} style={styles.image} />
      ...
      <View style={styles.qtyWrapper}>
        <TouchableOpacity
          style={[styles.qtyBtn, isMinusDisabled && styles.disabledBtn]}
          onPress={onRemove}
          disabled={isMinusDisabled}
        >
          <Ionicons name="remove" size={16} color={isMinusDisabled ? '#ccc' : Colors.primary} />
        </TouchableOpacity>
